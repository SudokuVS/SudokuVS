...
public class RegisterModel : PageModel
{
    ...
    readonly IUserStore<AppUser> _userStore;
    readonly IUserEmailStore<AppUser> _emailStore;
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                ...
                string callbackUrl = Url.Page("/Account/ConfirmEmail", null, new { area = "Identity", userId, code, returnUrl }, Request.Scheme);

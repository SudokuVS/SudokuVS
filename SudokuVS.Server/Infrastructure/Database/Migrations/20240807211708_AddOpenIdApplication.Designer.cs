...
namespace SudokuVS.Server.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240807211708_AddOpenIdApplication")]
    partial class AddOpenIdApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SudokuVS.Server.Infrastructure.Authentication.OpenIdConnect.Services.UserOpenIdApplicationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SudokuVS.Server.Infrastructure.Authentication.OpenIdConnect.Services.UserOpenIdApplicationEntity", b =>
                {
                    b.HasOne("SudokuVS.Server.Infrastructure.Database.Models.AppUser", "Owner")
                        .WithMany()
